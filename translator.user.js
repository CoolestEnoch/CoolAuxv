...
(function () {
    ...
    const ensureProviderTemplate = (tpl) => {
        ...
        const supportsContinuousChat = tpl.supportsContinuousChat !== undefined
            ...
            box.innerHTML = `
                ...
                <div id="coolauxv-provider-form-body" style="flex:1; overflow-y:auto; padding-right:4px;">
                    <div id="coolauxv-provider-form-manual" style="display:flex; flex-direction:column; gap:10px;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">显示名称
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">Base URL (支持 {{自定义字段}})
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">API KEY Placeholder
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">KEY 获取链接
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">协议类型
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">支持识图
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">连续对话
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">角色名 (system / user / assistant)
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">响应解析 (Delta / 推理路径)
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">请求头模板 (JSON)
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">请求体模板 (JSON)
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
                        ...
                        <div class="coolauxv-sub-label coolauxv-sub-label-inline">模型配置
                            <label class="coolauxv-toggle-label" style="margin-left:auto; width:auto; background:none; padding:0; border:none; font-weight:normal;">
            ...
            if (submitBtn) {
                submitBtn.onclick = () => {
                    if (modeTab === "base64") {
                        ...
                        const nextTemplates = getProviderTemplates().concat(imported);
